...
import 'package:flutter_widget_demo/page/listview_separated_page.dart';
import 'package:flutter_widget_demo/page/media_query_page.dart';

import 'page/anmations_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/Page19': (context) => MediaQueryPage(),
        '/Page120': (context) => ReactivePage(),
        '/Page21': (context)=> ListViewSeparatedPage(),
        '/Page22': (context)=> AnimationsPage(),
      },
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: ListView.separated( //separated 方式最大的理解是有直接的分隔符设置方式，对分隔符列表应用更实用
          ...
          separatorBuilder: (context, index) { //设置 separatorBuilder 属性即可  用于多类型 分割
